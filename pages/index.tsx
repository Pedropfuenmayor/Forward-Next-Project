  ...
  return (
    ...
    <div className="container py-12 mx-auto">
        <div className="w-9/12 mx-auto mt-16">
            ...
            <p className="mt-6 text-gray-800 text-lg leading-8 :leading-10 md:text-xl">Clean framework to generate ideas. Minimal contextual distraction, maximal output. Identify problems, generate solution and prioritize on what matter to your project.</p>
